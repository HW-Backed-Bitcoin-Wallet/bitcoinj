...
public class ECKeyTest {
    ...
    public void testEncryptionIsReversible() {
        ...
        encryptedPrivateKey = new EncryptedData(encryptedPrivateKey.initialisationVector, badEncryptedPrivateKeyBytes, Protos.Wallet.EncryptionType.ENCRYPTED_SCRYPT_AES);
